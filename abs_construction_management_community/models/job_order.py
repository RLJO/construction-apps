...
class ProjectTask(models.Model):
    ...
    def action_view_job_notes(self):
        return {
                ...
                'res_model': 'job.notes',
                'view_id': False,
                'views': [(self.env.ref('abs_construction_management_community.view_job_notes_menu_tree').id, 'tree'),(self.env.ref('abs_construction_management_community.view_job_notes_menu_form').id, 'form')],
                'type': 'ir.actions.act_window'
               }
    ...
    def action_view_project_issues(self):
        return {
                ...
                'view_id': False,
                'views': [(self.env.ref('abs_construction_management_community.view_project_issue_menu_tree').id, 'tree'),(self.env.ref('abs_construction_management_community.view_project_issue_menu_form').id, 'form')],
                'type': 'ir.actions.act_window'
               }
    ...
    def action_view_equipment_request(self):
        return {
                ...
                'view_id': False,
                'views': [(self.env.ref('abs_construction_management_community.view_equipment_request_menu_tree').id, 'tree'),(self.env.ref('abs_construction_management_community.view_equipment_request_menu_form').id, 'form')],
                'type': 'ir.actions.act_window'
               }
    ...
    def action_view_vehicle_request(self):
        return {
                ...
                'view_id': False,
                'views': [(self.env.ref('abs_construction_management_community.view_vehicle_request_menu_tree').id, 'tree'),
                          (self.env.ref('abs_construction_management_community.view_vehicle_request_menu_form').id, 'form')],
                'type': 'ir.actions.act_window'
               }
