...
#################################################################################
{
    'name': "Construction Management System (Odoo v14 Community)",
    ...
    'data': [
             ...
             'wizard/transfer_project_store.xml',
             'wizard/transfer_store_project.xml',
             ...
             'views/store_transfer.xml',
             'views/project_stock_view.xml',
